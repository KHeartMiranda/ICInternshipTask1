...
{
    [Binding]
    public class ASpecFlowFeature2Steps
    {
        ...
        public void WhenIAddANewSkill()
        {
            ...
            //Add Skill
            Driver.driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[3]/div/div[2]/div/div/div[1]/input")).SendKeys("API Testing");
        ...
        public void ThenThatSkillShouldBeDisplayedOnMyListings()
        {
            try
            {
                ...
                Thread.Sleep(1000);
                string ExpectedValue = "API Testing";
